...
export const BoqExtractionStatusValues = ["RECEIVED", "EXTRACTED", "VERIFICATION_REQUIRED", "FAILED"] as const;
export type BoqExtractionStatus = (typeof BoqExtractionStatusValues)[number];

export const BoqRowClassValues = ["DIRECT_EXECUTION_SCOPE", "PROCUREMENT_OR_SUPPLY", "TESTING_COMMISSIONING", "APPROVAL_INSPECTION", "PRELIMINARIES_GENERAL", "SUMMARY_HEADER", "SUBTOTAL_TOTAL", "PROVISIONAL_OR_ALLOWANCE", "MATERIAL_ONLY_NON_SCHEDULE", "UNKNOWN_REVIEW_REQUIRED"] as const;
export type BoqRowClass = (typeof BoqRowClassValues)[number];

export const ScheduleActivityArchetypeValues = ["SUBMITTAL", "PROCUREMENT", "DELIVERY", "MOBILIZATION", "EXECUTION", "INSPECTION_RELEASE", "TESTING_COMMISSIONING", "HANDOVER", "MILESTONE", "PLANNING_PLACEHOLDER"] as const;
export type ScheduleActivityArchetype = (typeof ScheduleActivityArchetypeValues)[number];

export const PlanningConfidenceValues = ["HIGH", "MEDIUM", "LOW", "INSUFFICIENT"] as const;
export type PlanningConfidence = (typeof PlanningConfidenceValues)[number];

export const PlanningAssumptionStatusValues = ["OPEN", "VALIDATED", "REJECTED", "SUPERSEDED"] as const;
export type PlanningAssumptionStatus = (typeof PlanningAssumptionStatusValues)[number];

export const ScheduleDraftStateValues = ["DRAFT_GENERATED", "VERIFICATION_REQUIRED", "PLANNER_REVIEW_READY", "PLANNER_REVIEWED", "PM_APPROVAL_REQUIRED", "CURRENT_AUTHORIZED", "BASELINE_AUTHORIZED"] as const;
export type ScheduleDraftState = (typeof ScheduleDraftStateValues)[number];

export const PlanningReviewStateValues = ["NOT_REVIEWED", "REVIEW_REQUIRED", "ACCEPTED", "REVISED", "REJECTED"] as const;
export type PlanningReviewState = (typeof PlanningReviewStateValues)[number];

export const PlanningStructureStatusValues = ["PROPOSED", "REVIEWED", "REJECTED"] as const;
export type PlanningStructureStatus = (typeof PlanningStructureStatusValues)[number];

export const PlanningStructureActionValues = ["GENERATE", "SPLIT_PACKAGE", "MERGE_PACKAGES", "REMAP_LINE", "ACCEPT_PROPOSAL", "REJECT_PROPOSAL"] as const;
export type PlanningStructureAction = (typeof PlanningStructureActionValues)[number];

export const DurationStatusValues = ["CALCULATED", "EXPLICIT", "VERIFICATION_REQUIRED"] as const;
export type DurationStatus = (typeof DurationStatusValues)[number];

export const DurationBasisValues = ["EXPLICIT_PROJECT_DURATION", "PROJECT_PRODUCTIVITY", "CONTROLLED_PRODUCTIVITY_LIBRARY", "TEMPLATE_RULE", "UNRESOLVED"] as const;
export type DurationBasis = (typeof DurationBasisValues)[number];

export const ProductivitySourceTypeValues = ["PROJECT_HISTORICAL_ACTUAL", "COMPANY_HISTORICAL_BENCHMARK", "PLANNER_INPUT", "SUBCONTRACTOR_PLAN", "CONTROLLED_REFERENCE_LIBRARY", "EXPLICIT_ASSUMPTION"] as const;
export type ProductivitySourceType = (typeof ProductivitySourceTypeValues)[number];

export const DependencyBasisValues = ["EXPLICIT_IMPORTED", "PROJECT_PLANNING_RULE", "VALIDATED_SEQUENCE_TEMPLATE", "PHYSICAL_PREREQUISITE", "APPROVAL_RELEASE_PREREQUISITE", "PROCUREMENT_PREREQUISITE", "LOCATION_TRADE_SEQUENCE", "BOUNDED_SEMANTIC_SUGGESTION"] as const;
export type DependencyBasis = (typeof DependencyBasisValues)[number];

export const MilestoneSourceTypeValues = ["PROJECT_SETUP", "CONTRACT_EVIDENCE", "BOQ_WORDING", "HANDOVER_REQUIREMENT", "USER_INPUT"] as const;
export type MilestoneSourceType = (typeof MilestoneSourceTypeValues)[number];

export const BootstrapReadinessValues = ["DRAFT_GENERATED", "VALIDATION_BLOCKED", "PLANNER_REVIEW_REQUIRED", "PM_APPROVAL_REQUIRED", "CURRENT_AUTHORIZED", "BASELINE_AUTHORIZED"] as const;
export type BootstrapReadiness = (typeof BootstrapReadinessValues)[number];

export const BootstrapValidationSeverityValues = ["INFO", "WARNING", "BLOCKER"] as const;
export type BootstrapValidationSeverity = (typeof BootstrapValidationSeverityValues)[number];

export const BootstrapExportFormatValues = ["JSON", "CSV", "XLSX"] as const;
export type BootstrapExportFormat = (typeof BootstrapExportFormatValues)[number];
